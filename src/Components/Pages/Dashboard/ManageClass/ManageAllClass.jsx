...
const ManageAllClass = ({item}) => {
	...
	<div className="flex items-center justify-between p-3">
		<div className="flex items-center space-x-2">
			<img src={item.instructoreImage} alt="" className="object-cover object-center w-8 h-8 rounded-full shadow-sm dark:bg-gray-500 dark:border-gray-700" />
			<div className="-space-y-1">
				<h2 className="text-sm font-semibold leadi">{item.InstructoreName}</h2>
                <span className="inline-block text-xs leadi dark:text-gray-400">{item.InstructoreEmail}</span>
			</div>
		</div>
	...
	<div className="p-3">
		...
		<div className="flex flex-wrap items-center pt-3 pb-1">
			<div className="flex items-center space-x-2">
				...
				<span className="text-sm">Liked by
					<span className="font-semibold"> Mahmud Zia </span> and
		...
		<div className="space-y-3">
			<p className="text-sm grid grid-cols-2">
				<span className="text-base font-semibold">ClassName : </span>{item.name}
